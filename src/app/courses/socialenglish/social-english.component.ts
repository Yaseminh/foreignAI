...
@Component({
  selector: 'app-social-english',
  templateUrl: './social-english.component.html',
  styleUrls: ['./social-english.component.css']
})
export class SocialEnglishComponent implements OnInit {
